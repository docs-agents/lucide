...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/docs-agents/lucide

features:
  - title: 轻量且可扩展
    details: 图标采用轻量级、高度优化的可缩放矢量图形（SVG）。
    icon: |
  ...
  - title: 简洁一致
    details: 遵循严格的设计规范，确保风格和可读性的一致性。
    icon: |
  ...
  - title: 活跃的社区
    details: Lucide 在 GitHub 和 Discord 上拥有活跃的社区。
    icon: |
